...
//     {1, 10.927, 9.55, 5.366, 9.55, -1, 0, -100, 0}};
// circle
//   double controlArray[1][9] = {
...
double controlArray[][9] = {
    {1, 1, 9, 1, 3, 0, -1, 1, 3},
    {0, 3, 3, 2, 1, 1, 0, 3, 1},
    {1, 3, 1, 6, 1.5, 1, 0, 6, 1.5},
    {1, 6, 1.5, 9, 1, 1, 0, 9, 1},
    {0, 9, 3, 2, 1, 0, 1, 11, 3.5},
    {0, 9.5, 4, 2, 1, 0, -1, 9.5, 6},
    {1, 9.5, 6, 7, 3.8, -1, 0, 7, 3.8},
    {1, 7, 3.8, 3.5, 4.5, 0, 1, 3.5, 4.5},
    {1, 3.5, 4.5, 3, 7, 0, 1, 3, 7},
    {0, 4, 7, 1, 0, 1, 0, 4, 8},
    {1, 4, 8, 9, 9, 1, 0, 9, 9},
    {0, 9.5, 10.5, 2, 1, -1, 0, 9.5, 11.5},
    {1, 9.5, 11.5, 6, 10.5, -1, 0, 6, 10.5},
    {1, 6, 10.5, 2, 10.5, -1, 0, 2, 10.5},
    {0, 2, 9, 1.5, 1, 0, -1, 1, 9},
};
...
void topLevel(void)
{
    ...
    FILE *fptr;
    fptr = fopen("C:\\users\\auggi\\dataread.txt", "a");
    // fopen("C:\\users\\auggi\\dataread.txt", "a")
    printf("\n\n\n\n\n\nNew Test\n");
    //  new test header write that later

...
if __name__ == '__main__':
    try:
        ...
        speed = 78
        turn = 0.4 #How long it turn - 0.6 (76)
        straight = 0.3 #How long straight - 0.5 (76)
        ...
        while True:
            ...
            if turnIncrement == False:
                ...
                if (frontDist <= turnDistance-6) and backUpFlag != True: #frontDist <= turnDistance-6:
                    if rightDist < leftDist:
                        backUp(0)
                    if leftDist < rightDist:
                        backUp(0)
